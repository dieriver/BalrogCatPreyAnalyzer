...
class FlapLocker:
    ...
    async def get_pets_data(self, *args: Any) -> Dict[str, int]:
    ...
    async def get_devices_data(self, *args: Any) -> Dict[str, int]:
    ...
    async def send_pets_data(self, msg_sender: MessageSender, *args: Any) -> None:
        # list with all pets
    ...
    async def lock_moria_in(self, msg_sender: MessageSender, *args: Any) -> None:
        await self._set_moria_lock_state(LockState.LOCKED_IN, msg_sender)

    async def lock_moria_out(self, msg_sender: MessageSender, *args: Any) -> None:
        await self._set_moria_lock_state(LockState.LOCKED_OUT, msg_sender)

    async def lock_moria(self, msg_sender: MessageSender, *args: Any) -> None:
        await self._set_moria_lock_state(LockState.LOCKED_ALL, msg_sender)

    async def activate_curfew(self, msg_sender: MessageSender, *args: Any) -> None:
        await self._set_moria_lock_state(LockState.CURFEW, msg_sender)

    async def lock_moria_curfew(self, msg_sender: MessageSender, *args: Any) -> None:
        await self._set_moria_lock_state(LockState.CURFEW_LOCKED, msg_sender)

    async def unlock_moria_curfew(self, msg_sender: MessageSender, *args: Any) -> None:
