...
class NodeBot:
    ...
    def init_bot_listener(self):
        ...
        lockMoria = CommandHandler('lock', self.lock_moria)
        self.bot_dispatcher.add_handler(lockMoria)
        unlockMoria = CommandHandler('unlock', self.unlock_moria)
        self.bot_dispatcher.add_handler(unlockMoria)
        lockMoriaIn = CommandHandler('lockin', self.lock_moria_in)
        self.bot_dispatcher.add_handler(lockMoriaIn)
        lockMoriaOut = CommandHandler('lockout', self.lock_moria_out)
        self.bot_dispatcher.add_handler(lockMoriaOut)
